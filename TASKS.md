...
- [x] Add the Rust package, CLI argument contract, and protocol id helpers.
...
- [x] Add bounded stdin/stdout frame forwarding.
...
- [x] Add first-request and per-request deadlines.
...
- [x] Add bilingual README, security policy, contribution guide, changelog, and
  release checklist.
  - Acceptance: English is the default entry point and Chinese is linked.
  - Verify: documentation contract script.
- [x] Add fixed-SHA CI, CodeQL, cargo-deny, cargo-audit, Dependabot, and release
